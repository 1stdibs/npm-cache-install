...
then
	echo << err
node_modules/npm-module-cache.hash is not consistent with your package.json.
Either bring back the package.json that was used to install them, or re-install your node_modules.
err
	exit 1
fi
